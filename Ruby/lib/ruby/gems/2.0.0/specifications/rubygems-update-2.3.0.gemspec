...
Gem::Specification.new do |s|
  ...
  s.files = ["bin/update_rubygems", "CVE-2013-4287.txt", "CVE-2013-4363.txt", "History.txt", "LICENSE.txt", "MIT.txt", "Manifest.txt", "README.rdoc", "UPGRADING.rdoc", "hide_lib_for_update/note.txt"]
